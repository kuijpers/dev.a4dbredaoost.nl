$(document).ready(function() {
	...
	$('#submit_new').on('click',function(e) {
		...
		var description			= 'Uitleg over het sponsor systeem';
		...
		var url					= '/api/board/sponsors/information/create';
	...
	console.log('description -> ' + description);
		...
		create_new_article(title , body , description , author_approved , editor_approved , url);

	});

	function create_new_article(title , body , description , author_approved , editor_approved , url){

		// console.log(title , body , description , author_approved , editor_approved, url );
		//
		// alert( 'test gedaan' );
