        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="edit_treasurer_unpaid_form"
                      ...
                      method="post"
                      action="<?php echo e(route('board.sponsors.treasurer.edit')); ?>"
                >
                        ...
                        <div class="modal-body">
                            ...
                            <div class="col-md-12 text-primary">
                                ...
                                <div class="col-md-12 edit_treasurer_unpaid_image margin-top-md text-center">
                                    <img src=" <?php echo e(asset('img/no-image.png')); ?> " id="edit_treasurer_unpaid_logo_sponsor" class="img-thumbnail" style="max-width:300px;">
                                </div>
