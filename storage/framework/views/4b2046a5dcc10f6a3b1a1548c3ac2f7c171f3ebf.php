                    ...
                    <div class="col-md-10 col-lg-offset-1">
                        <div class="modal-header">
                            <h4 class="modal-title text-danger">
                                <?php echo app('translator')->getFromJson('didyouknow::board/modals.modal_view_title_editor'); ?>
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-10 col-lg-offset-1">
                        <div class="modal-body">
                            ...
                            <div class="col-md-12 view_author_image margin-top-md text-center">
                                <img src=" <?php echo e(asset('img/no-image.png')); ?> " id="view_author_approved_logo_sponsor" class="img-thumbnail" style="max-width:300px;">
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4 text-primary">
                                    <?php echo app('translator')->getFromJson('didyouknow::board/modals.modal_view_process_editor'); ?>
                                </div>
