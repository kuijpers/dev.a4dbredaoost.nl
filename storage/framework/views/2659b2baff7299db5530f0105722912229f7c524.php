        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="edit_author_approved_form"
                      ...
                      method="post"
                      action="<?php echo e(route('board.sponsors.editor.edit')); ?>"
                        ...
                        <div class="col-md-10 col-lg-offset-1">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-12 edit_author_image margin-top-md text-center">
                                    <img id="edit_author_approved_show_logo" src=" <?php echo e(asset('img/no-image.png')); ?> " class="img-thumbnail logo_sponsor" style="max-width:300px;">
                                </div>
