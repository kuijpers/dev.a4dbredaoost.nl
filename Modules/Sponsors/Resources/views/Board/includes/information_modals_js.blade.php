...
@if($rpc->CanAccessAs(['webmaster' , 'admin' , 'author']))
    <script src="{{ Module::asset('sponsors:js/modals/personal_drafts.js') }}"></script>
@endif
...
{{--New article--}}
@if($rpc->CanAccessAs(['webmaster' , 'admin' , 'author']))
    <script src="{{ Module::asset('sponsors:js/modals/new_article.js') }}"></script>
@endif


{{--Helper function--}}
<script src="{{ Module::asset('sponsors:js/modals/modal_helpers.js') }}"></script>
