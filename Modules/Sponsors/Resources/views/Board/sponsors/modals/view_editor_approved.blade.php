                    ...
                    <div class="col-md-10 col-lg-offset-1">
                        <div class="modal-header">
                            <h4 class="modal-title text-danger">
                                @lang('didyouknow::board/modals.modal_view_title_publisher')
                            </h4>
                        </div>
                    </div>
                    ...
                    <div class="col-md-10 col-lg-offset-1">
                        <div class="modal-body">
                            ...
                            <div class="col-md-12 view_treasurer_unpaid_image margin-top-md text-center">
                                <img src=" {{asset('img/no-image.png')}} " id="view_editor_approved_logo_sponsor" class="img-thumbnail" style="max-width:300px;">
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="col-md-4 text-primary">
                                    @lang('didyouknow::board/modals.modal_view_process_publisher')
                                </div>
