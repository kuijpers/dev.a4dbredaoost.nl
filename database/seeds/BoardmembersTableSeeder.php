    ...
    public function run()
    {
    	...
    	$boardmember = [
			[
				...
				'secondary_email' => '',
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_FRANSWILLEM')),
			...
			[
				...
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_ROY')),
			...
			[
				...
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_MIRJAM')),
			...
			[
				...
				'secondary_email' => '',
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_MICHA')),
			...
			[
				...
				'secondary_email' => '',
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_ANKE')),
			...
			[
				'name' => 'Jeroen Tonnet',
				'slug' => str_slug('Jeroen Tonnet'.time(), '-'),
				'email' => 'contact.a4dbredaoost@gmail.com',
				'secondary_email' => '',
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_JEROEN')),
			...
			[
				...
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_DENNIS')),
			...
			[
				'name' => 'Nard Hoefnagels',
				'slug' => str_slug('Nard Hoefnagels'.time(), '-'),
				'email' => 'info.a4dbredaoost@gmail.com',
				'secondary_email' => '',
				'password' => bcrypt(env('BOARDMEMBER_PASSWORD_NARD')),
				'address' => 'Weilustlaan 2134',
				'postcode' => '4817 ZZ',
				'city' => 'Breda',
				'country' => 'Nederland',
